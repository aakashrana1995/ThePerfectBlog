    ...
    <nav class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="views/index.php">Welcome <?php echo "$u_name" ?></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="views/new_post.php">New Post</a>
                    </li>
                    <li>
                        <a href="views/my_posts.php">My Posts</a>
                    </li>
					<li>
                        <a href="views/contact_us.html">Contact Us</a>
                    </li>
                    <li>
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <div class="post-preview">
                    <a href="views/post.php?link=<?php echo $row['blog_id'];?>">
                        <h2 class="post-title">
							<?php 
								echo $row['blog_title'];
							?>
							...
							<div class="row">
									...
									<?php
										...
										$original_string = strip_tags($original_string);
											...
											echo $trimmed_string;
									?>
										<a href="views/post.php?link=<?php echo $blog_id ?>"> read more </a>
									</p>
							</div>
						</div>
					</article>
                    ...
                    <p class="post-meta">Posted by <a href="views/profile.php?username=<?php echo $row['blog_author'];?>"> <?php echo $row['blog_author']; ?> </a> on <?php echo $row[3]; ?>
