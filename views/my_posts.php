...
$sql = "SELECT blog_title, blog_category, blog_author, updated_date, blog_desc, blog_id FROM blog_master WHERE blog_author='$u_name' ORDER BY updated_date DESC;";
                ...
                <div class="post-preview">
                    <a href="post.php?link=<?php echo $row['blog_id'];?>">
                        <h2 class="post-title">
							...
							<a href="edit_post.php?blog_id=<?php echo  $row['blog_id'];?>"> <button class="btn btn-default"> EDIT </button></h1> </a>
                        </h2>
                    </a>
