    ...
    <nav class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="admin_index.php">Welcome <?php echo "$u_name" ?></a>
            </div>
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <div class="post-preview">
                    <a href="admin_profile.php?username=<?php echo $row['blogger_username'];?>">
                        <h2 class="post-title">
							<?php 
                    ...
                    echo 'Active Satus: '; if($row['blogger_is_active']==1) echo 'Yes'; else echo 'No';
									?><br>
			<button class="btn btn-default" type="submit"> <a href="change_permissions.php?username=<?php echo $row['blogger_username'];?> "> <?php if($row['blogger_is_active']==1) echo 'Deactivate'; else echo 'Activate'; ?></a></button>
									</p>
							</div>
						</div>
					</article>
